...
const Header = ({sendData}) => {
    ...
    const {title, desc} = sendData;

  return (
    <header className=" py-8 mt-10">
      <div className="container max-w-8xl mx-auto flex flex-col md:flex-row items-center justify-between px-10">
        ...
        <figure>
             <img src="../images/header.jpg" alt="Your Image" className="w-full"  />
        </figure>
        </div>
      </div>
    </header>
